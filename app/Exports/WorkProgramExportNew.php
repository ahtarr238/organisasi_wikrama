...
class WorkProgramExportNew implements FromCollection, WithHeadings, WithTitle, WithEvents
{
    /**
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Menambahkan footer
                $event->sheet->setCellValue('A' . ($highestRow + 2), 'Total Program Kerja: ' . ($highestRow - 1));
