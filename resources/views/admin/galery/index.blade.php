...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{route('admin.galery.export')}}" class="btn btn-success btn-sm me-2">
                <i class="fas fa-download me-2"></i>Export CSV
            </a>
            <a href="{{route('admin.galery.trash')}}" class="btn btn-info btn-sm me-2">
                <i class="fas fa-trash me-2"></i>Data Dihapus
            </a>
            <a href="{{route('admin.galery.create')}}" class="btn btn-primary btn-sm">
