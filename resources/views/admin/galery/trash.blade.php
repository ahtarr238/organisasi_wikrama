...
@section('title', 'Galeri yang Dihapus - Admin')

@section('content')
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold">Galeri yang Dihapus</h4>
        <div>
            <a href="{{route('admin.galery.index')}}" class="btn btn-secondary btn-sm me-2">
            ...
            <table class="table align-middle mb-0 bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <form action="{{route('admin.galery.restore', $gallery->id)}}" method="POST" class="d-inline">
                                @csrf
                            ...
                            <form action="{{route('admin.galery.forceDelete', $gallery->id)}}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
