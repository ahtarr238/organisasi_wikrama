...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 mt-3 animate__animated animate__fadeInDown">
        ...
        <div>
            <a href="{{route('staff.galery.export')}}" class="btn btn-success btn-sm me-2 animate__animated animate__fadeInRight">
                <i class="fas fa-download me-2"></i>Export CSV
            </a>
            <a href="{{route('staff.galery.trash')}}" class="btn btn-info btn-sm me-2 animate__animated animate__fadeInRight" style="animation-delay: 0.1s">
                <i class="fas fa-trash me-2"></i>Data Dihapus
            </a>
            <a href="{{route('staff.galery.create')}}" class="btn btn-primary btn-sm animate__animated animate__fadeInRight" style="animation-delay: 0.2s">
    ...
    <div class="card shadow-sm animate__animated animate__fadeInUp">
        <div class="card-header bg-gradient text-white" style="background: linear-gradient(45deg, var(--warning-color), #ff9800);">
            <h5 class="mb-0 fw-bold">Daftar Galeri</h5>
        </div>
        <div class="card-body p-4">
            <div class="row">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="badge bg-primary px-3 py-2">{{ strtoupper($gallery->category) }}</span>
                                ...
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('staff.galery.edit', $gallery->id) }}" class="btn btn-sm btn-outline-primary me-2" title="Edit">
                ...
                <div class="col-12 text-center text-muted py-5 animate__animated animate__fadeIn">
                    ...
                    <a href="{{route('staff.galery.create')}}" class="btn btn-primary mt-3">
